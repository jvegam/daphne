...
#ifndef STM32H7xx_HAL_AFE_H
#define STM32H7xx_HAL_AFE_H
...
/* Exported types ------------------------------------------------------------*/
/** @defgroup AFE_Exported_Types AFE Exported Types
  * @{
  */

/**
  * @brief  AFE group regular oversampling structure definition
  */
typedef struct
{
